...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex  w-full items-center justify-center bg-black py-20",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-[0.5rem] bg-gradient-to-r  px-1 pb-1 from-indigo-500 to-purple-500`,
        className
      )}
    >
      {children}
